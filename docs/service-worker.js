const CACHE_NAME = 'weather-dashboard-v64';
const urlsToCache = [
  '/'
];

// Don't cache these files - always fetch fresh
const noCacheFiles = [
  'app.js',
  'overview-new.js',
  'index.html',
  '.js',
  '.css'  // Always fetch CSS fresh to get latest styles
];

// Force immediate activation
self.addEventListener('install', event => {
  console.log('Service Worker v64 installing...');
...
self.addEventListener('fetch', event => {
  ...
  // Skip caching for the main page / index.html - always fetch fresh
  ...
  // Skip caching for CSS files - always fetch fresh to get latest styles
...
self.addEventListener('activate', event => {
  console.log('Service Worker v61 activating - clearing ALL old caches...');
  event.waitUntil(
