...
function updateQuickStats(indoor, aurora, smhi) {
  ...
  if (overviewKpEl && aurora.kp !== undefined) {
    overviewKpEl.textContent = aurora.kp.toFixed(1);
  }
  if (overviewAuroraSummaryEl && aurora.description) {
    overviewAuroraSummaryEl.textContent = aurora.description;
  }
